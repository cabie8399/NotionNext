...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zaxc', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '陪你週週成長的好夥伴🤝🤝', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-e1bkl3jtk-cabie8399s-projects.vercel.app/', // 网站地址
